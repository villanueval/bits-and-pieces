...
#status, output = commands.getstatusoutput('scp ' + tar_name + '.tar lvillanu@fortress.rcac.purdue.edu:/archive/fortress/home/lvillanu/archives2011/')
#status, output = commands.getstatusoutput('mv ' + tar_name + '.tar /home/ljvillanueva/tip2012/tars/')
#if status != 0:
#	print " Problem moving the file " + tar_name + " to TARS"
#	print output
#	print " "
#	print " Exiting program."
#	sys.exit(1)
#else:
#	print "\n Tar file ready to be copied to Fortress.\n"
	#status, output = commands.getstatusoutput('rm ' + tar_name + '.tar')
