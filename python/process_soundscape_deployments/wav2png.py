...
def create_png(input_filename, output_filename_w, output_filename_s, image_width, image_height, fft_size, f_max):
...
if __name__ == '__main__':
    ...
    parser.set_defaults(output_filename_w=None, output_filename_s=None, image_width=500, image_height=170, fft_size=2048, f_max=22050)
    ...
    for input_file in args:
        ...
        output_file_w = options.output_filename_w or input_file[:-4] + "_w.png"
        output_file_s = options.output_filename_s or input_file[:-4] + "_s.png"
